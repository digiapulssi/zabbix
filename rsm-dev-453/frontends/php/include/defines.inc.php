...
define('RSM_MONITORING_TYPE', '{$RSM.MONITORING.TYPE}');
define('RSM_MONITORING_TYPE_REGISTRY', 1);
define('RSM_MONITORING_TYPE_REGISTRAR', 2);

define('REGISTRAR_FAMILY_MACROS', '{$REGISTRAR.FAMILY}');
define('REGISTRAR_NAME_MACROS', '{$REGISTRAR.NAME}');

define('DNS_TLD_ENABLED', '{$DNS.TLD.ENABLED}');

...
INSERT INTO hosts (hostid, host, name, status, description) VALUES (99009, 'Dependent items template 3', 'Dependent items template 3', 3, '');
...
INSERT INTO items (itemid, hostid, templateid, interfaceid, type, value_type, name, key_, delay, history, status, params, description, flags, master_itemid) VALUES (40575, 99008, NULL, NULL, 2, 3, 'A', 'item.A', '0', '90d', 0, '', '', 0, NULL);
INSERT INTO items (itemid, hostid, templateid, interfaceid, type, value_type, name, key_, delay, history, status, params, description, flags, master_itemid) VALUES (40576, 99008, NULL, NULL, 18, 3, 'B', 'item.B', '0', '90d', 0, '', '', 0, 40575);
INSERT INTO items (itemid, hostid, templateid, interfaceid, type, value_type, name, key_, delay, history, status, params, description, flags, master_itemid) VALUES (40577, 99008, NULL, NULL, 18, 3, 'C', 'item.C', '0', '90d', 0, '', '', 0, 40576);
INSERT INTO items (itemid, hostid, templateid, interfaceid, type, value_type, name, key_, delay, history, status, params, description, flags, master_itemid) VALUES (40578, 99008, NULL, NULL, 18, 3, 'D', 'item.D', '0', '90d', 0, '', '', 0, 40577);
INSERT INTO items (itemid, hostid, templateid, interfaceid, type, value_type, name, key_, delay, history, status, params, description, flags, master_itemid) VALUES (40579, 99009, NULL, NULL, 2, 3, '0A', 'item.0A', '0', '90d', 0, '', '', 0, NULL);
INSERT INTO items (itemid, hostid, templateid, interfaceid, type, value_type, name, key_, delay, history, status, params, description, flags, master_itemid) VALUES (40580, 99009, NULL, NULL, 18, 3, 'A', 'item.A', '0', '90d', 0, '', '', 0, 40579);
INSERT INTO items (itemid, hostid, templateid, interfaceid, type, value_type, name, key_, delay, history, status, params, description, flags, master_itemid) VALUES (40581, 99009, NULL, NULL, 18, 3, 'B', 'item.B', '0', '90d', 0, '', '', 0, 40580);
INSERT INTO items (itemid, hostid, templateid, interfaceid, type, value_type, name, key_, delay, history, status, params, description, flags, master_itemid) VALUES (40582, 99009, NULL, NULL, 18, 3, 'C', 'item.C', '0', '90d', 0, '', '', 0, 40581);

...
// Don't delete messages from MVC when calling JSON RPC.
if ($page['type'] != PAGE_TYPE_JSON_RPC) {
...
// function show_messages() will clear messages that are shown. Suppress showing till actual HTML page.
if ($page['type'] != PAGE_TYPE_JSON_RPC) {
	show_messages();

...
ALTER TABLE `items` ADD INDEX `flags`(`flags`), ALGORITHM=INPLACE;
ALTER TABLE `items` ADD INDEX `type`(`type`), ALGORITHM=INPLACE;

ALTER TABLE `dbversion` ADD `id` bigint unsigned NOT NULL AUTO_INCREMENT PRIMARY KEY FIRST;

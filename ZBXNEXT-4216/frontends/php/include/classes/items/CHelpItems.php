	...
	protected function getItems() {
		return [
			...
			ITEM_TYPE_ZABBIX_ACTIVE => [
				...
				[
					'key' => 'logrt[file_regexp,<regexp>,<encoding>,<maxlines>,<mode>,<output>,<maxdelay>,<rotation_mode>]',
					'description' => _('Log file monitoring with log rotation support. Returns log')
				],
				[
					'key' => 'logrt.count[file_regexp,<regexp>,<encoding>,<maxproclines>,<mode>,<maxdelay>,<rotation_mode>]',

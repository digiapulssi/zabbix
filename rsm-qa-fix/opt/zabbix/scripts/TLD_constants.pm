...
use constant GLOBAL_MACRO_HISTORY_HOSTID	=> 100000;	# Host "Global macro history"
...
our @EXPORT_OK = qw(true false LINUX_TEMPLATEID APP_ZABBIX_PROXY_TEMPLATEID GLOBAL_MACRO_HISTORY_HOSTID
		    TEMPLATES_TLD_GROUPID PROBES_GROUPID PROBES_MON_GROUPID TLDS_GROUPID TLD_PROBE_RESULTS_GROUPID
		    TLD_TYPE_GROUPIDS TLD_TYPE_PROBE_RESULTS_GROUPIDS VALUE_TYPE_AVAIL VALUE_TYPE_PERC VALUE_TYPE_NUM
...
our %EXPORT_TAGS = ( general => [ qw(true false) ],
		     ...
		     hosts => [ qw(GLOBAL_MACRO_HISTORY_HOSTID) ],

...
INSERT INTO items (name, itemid, type, snmp_community, snmp_oid, hostid, description, key_, delay, history, trends, status, value_type, trapper_hosts, units, snmpv3_securityname, snmpv3_securitylevel, snmpv3_authpassphrase, snmpv3_privpassphrase, error, lastlogsize, logtimefmt, templateid, valuemapid, params, ipmi_sensor, authtype, username, password, publickey, privatekey, mtime, flags, interfaceid, port, posts, headers) VALUES ('a. i am referencing a non-existent user macro $1', 23100, 0, '', '', 10053, 'a. i am referencing a non-existent user macro $1', 'key[{$I_DONT_EXIST}]', '30s', '90d', '365d', 0, 0, '', '', '', 0, '', '', '', 0, '', NULL, NULL, '', '', 0, '', '', '', '', 0, 0, 10021, '', '', '');
INSERT INTO items (name, itemid, type, snmp_community, snmp_oid, hostid, description, key_, delay, history, trends, status, value_type, trapper_hosts, units, snmpv3_securityname, snmpv3_securitylevel, snmpv3_authpassphrase, snmpv3_privpassphrase, error, lastlogsize, logtimefmt, templateid, valuemapid, params, ipmi_sensor, authtype, username, password, publickey, privatekey, mtime, flags, interfaceid, port, inventory_link, posts, headers) VALUES ('i am populating filed Type', 23101, 0, '', '', 10053, 'i am populating filed Type', 'key.test.pop.type', '30s', '90d', '365d', 0, 0, '', '', '', 0, '', '', '', 0, '', NULL, NULL, '', '', 0, '', '', '', '', 0, 0, 10021, '', 1, '', '');
...
INSERT INTO maintenances (maintenanceid, name, maintenance_type, description, active_since, active_till) VALUES (3, 'Maintenance period 3 (data collection)', 0, 'Check Monitoring - Overview', 1533047880, 2147355480);
INSERT INTO timeperiods (timeperiodid, timeperiod_type, every, month, dayofweek, day, start_time, period, start_date) VALUES (11, 2, 1, 0, 0, 1, 54000, 86340, 1920);
INSERT INTO maintenances_windows (maintenance_timeperiodid, maintenanceid, timeperiodid) VALUES (11, 3, 11);
INSERT INTO hstgrp (groupid, name, internal) VALUES (50005, 'Group to check Monitoring-> Overview', 0);
INSERT INTO hstgrp (groupid, name, internal) VALUES (50006, 'Another group to check Monitoring-> Overview', 0);
...
INSERT INTO hosts (hostid, host, name, status, description, maintenanceid, maintenance_status, maintenance_type, maintenance_from) VALUES (50013, '4_Host_to_check_Monitoring_Overview', '4_Host_to_check_Monitoring_Overview', 0, '', 3, 1, 0, 1533643200);
INSERT INTO host_inventory (type, type_full, name, alias, os, os_full, os_short, serialno_a, serialno_b, tag, asset_tag, macaddress_a, macaddress_b, hardware, hardware_full, software, software_full, software_app_a, software_app_b, software_app_c, software_app_d, software_app_e, contact, location, location_lat, location_lon, notes, chassis, model, hw_arch, vendor, contract_number, installer_name, deployment_status, url_a, url_b, url_c, host_networks, host_netmask, host_router, oob_ip, oob_netmask, oob_router, date_hw_purchase, date_hw_install, date_hw_expiry, date_hw_decomm, site_address_a, site_address_b, site_address_c, site_city, site_state, site_country, site_zip, site_rack, site_notes, poc_1_name, poc_1_email, poc_1_phone_a, poc_1_phone_b, poc_1_cell, poc_1_screen, poc_1_notes, poc_2_name, poc_2_email, poc_2_phone_a, poc_2_phone_b, poc_2_cell, poc_2_screen, poc_2_notes, hostid) VALUES ('Type', 'Type (Full details)', 'Name', 'Alias', 'OS', 'OS (Full details)', 'OS (Short)', 'Serial number A', 'Serial number B', 'Tag','Asset tag', 'MAC address A', 'MAC address B', 'Hardware', 'Hardware (Full details)', 'Software', 'Software (Full details)', 'Software application A', 'Software application B', 'Software application C', 'Software application D', 'Software application E', 'Contact', 'Location', 'Location latitud', 'Location longitu', 'Notes', 'Chassis', 'Model', 'HW architecture', 'Vendor', 'Contract number', 'Installer name', 'Deployment status', 'URL A', 'URL B', 'URL C', 'Host networks', 'Host subnet mask', 'Host router', 'OOB IP address', 'OOB subnet mask', 'OOB router', 'Date HW purchased', 'Date HW installed', 'Date HW maintenance expires', 'Date hw decommissioned', 'Site address A', 'Site address B', 'Site address C', 'Site city', 'Site state / province', 'Site country', 'Site ZIP / postal', 'Site rack location', 'Site notes', 'Primary POC name', 'Primary POC email', 'Primary POC phone A', 'Primary POC phone B', 'Primary POC cell', 'Primary POC screen name', 'Primary POC notes', 'Secondary POC name', 'Secondary POC email', 'Secondary POC phone A', 'Secondary POC phone B', 'Secondary POC cell', 'Secondary POC screen name', 'Secondary POC notes', 50012);
INSERT INTO maintenances_hosts (maintenance_hostid, maintenanceid, hostid) VALUES (3, 3, 50013);
INSERT INTO hosts_groups (hostgroupid, hostid, groupid) VALUES (90282, 50011, 50005);
INSERT INTO hosts_groups (hostgroupid, hostid, groupid) VALUES (90283, 50012, 50005);
INSERT INTO hosts_groups (hostgroupid, hostid, groupid) VALUES (90284, 50013, 50006);
INSERT INTO interface (interfaceid, hostid, main, type, useip, ip, dns, port) values (50025,50011,1,1,1,'127.0.0.1','','10050');
INSERT INTO interface (interfaceid, hostid, main, type, useip, ip, dns, port) values (50026,50012,1,1,1,'127.0.0.1','','10050');
INSERT INTO interface (interfaceid, hostid, main, type, useip, ip, dns, port) values (50027,50013,1,1,1,'127.0.0.1','','10050');
...
INSERT INTO items (itemid, hostid, interfaceid, type, value_type, name, key_, delay, history, status, params, description, flags, posts, headers) VALUES (99086, 50011, 50025, 2, 3, '1_item','trap[1]', '30s', '90d', 0, '', '', 0, '', '');
INSERT INTO items_applications (itemappid, applicationid, itemid) VALUES (99002, 99010, 99086);
INSERT INTO items (itemid, hostid, interfaceid, type, value_type, name, key_, delay, history, status, params, description, flags, posts, headers) VALUES (99087, 50011, 50025, 2, 3, '2_item','trap[2]', '30s', '90d', 0, '', '', 0, '', '');
INSERT INTO items_applications (itemappid, applicationid, itemid) VALUES (99003, 99011, 99087);
INSERT INTO items (itemid, hostid, interfaceid, type, value_type, name, key_, delay, history, status, params, description, flags, posts, headers) VALUES (99088, 50012, 50026, 2, 3, '3_item','trap[3]', '30s', '90d', 0, '', '', 0, '', '');
INSERT INTO items_applications (itemappid, applicationid, itemid) VALUES (99004, 99012, 99088);
INSERT INTO items (itemid, hostid, interfaceid, type, value_type, name, key_, delay, history, status, params, description, flags, posts, headers) VALUES (99089, 50013, 50027, 2, 3, '4_item','trap[4]', '30s', '90d', 0, '', '', 0, '', '');
INSERT INTO items_applications (itemappid, applicationid, itemid) VALUES (99005, 99013, 99089);
INSERT INTO triggers (triggerid, description, expression, value, state, lastchange, comments, priority) VALUES (100030, '1_trigger_Not_classified', '{100030}>0', 1, 0, '1533555726', '', 0);
INSERT INTO triggers (triggerid, description, expression, value, state, lastchange, comments, priority) VALUES (100031, '1_trigger_Information', '{100031}>0', 1, 0, '1533555726', '', 1);
INSERT INTO triggers (triggerid, description, expression, value, state, lastchange, comments, priority) VALUES (100032, '1_trigger_Warning', '{100032}>0', 1, 0, '1533555726', '', 2);
INSERT INTO triggers (triggerid, description, expression, value, state, lastchange, comments, priority) VALUES (100033, '1_trigger_Average', '{100033}>0', 1, 0, '1533555726', '', 3);
INSERT INTO triggers (triggerid, description, expression, value, state, lastchange, comments, priority) VALUES (100034, '1_trigger_High', '{100034}>0', 1, 0, '1533555726', '', 4);
INSERT INTO triggers (triggerid, description, expression, value, state, lastchange, comments, priority) VALUES (100035, '1_trigger_Disaster', '{100035}>0', 1, 0, '1533555726', '', 5);
INSERT INTO triggers (triggerid, description, expression, value, state, lastchange, comments, priority) VALUES (100036, '2_trigger_Not_classified', '{100036}>0', 1, 0, '1533555726', '', 0);
...
INSERT INTO triggers (triggerid, description, expression, value, state, lastchange, comments, priority) VALUES (100038, '2_trigger_Warning', '{100038}>0', 1, 0, '1533555726', '', 2);
INSERT INTO triggers (triggerid, description, expression, value, state, lastchange, comments, priority) VALUES (100039, '2_trigger_Average', '{100039}>0', 1, 0, '1533555726', '', 3);
INSERT INTO triggers (triggerid, description, expression, value, state, lastchange, comments, priority) VALUES (100040, '2_trigger_High', '{100040}>0', 1, 0, '1533555726', '', 4);
INSERT INTO triggers (triggerid, description, expression, value, state, lastchange, comments, priority) VALUES (100041, '2_trigger_Disaster', '{100041}>0', 1, 0, '1533555726', '', 5);
INSERT INTO triggers (triggerid, description, expression, value, state, lastchange, comments, priority) VALUES (100042, '3_trigger_Average', '{100042}>0', 1, 0, '1533555726', '', 3);
INSERT INTO triggers (triggerid, description, expression, value, state, lastchange, comments, priority) VALUES (100043, '4_trigger_Average', '{100043}>0', 1, 0, '1533555726', '', 3);
INSERT INTO triggers (triggerid, description, expression, value, state, lastchange, comments, priority) VALUES (100044, '3_trigger_Disaster', '{100042}>0', 1, 0, '1533555726', '', 5);
INSERT INTO functions (functionid, itemid, triggerid, name, parameter) VALUES (100030, 99086, 100030, 'last', '0');
INSERT INTO functions (functionid, itemid, triggerid, name, parameter) VALUES (100031, 99086, 100031, 'last', '0');
...
INSERT INTO functions (functionid, itemid, triggerid, name, parameter) VALUES (100036, 99087, 100036, 'last', '0');
INSERT INTO functions (functionid, itemid, triggerid, name, parameter) VALUES (100037, 99087, 100037, 'last', '0');
INSERT INTO functions (functionid, itemid, triggerid, name, parameter) VALUES (100038, 99087, 100038, 'last', '0');
INSERT INTO functions (functionid, itemid, triggerid, name, parameter) VALUES (100039, 99087, 100039, 'last', '0');
INSERT INTO functions (functionid, itemid, triggerid, name, parameter) VALUES (100040, 99087, 100040, 'last', '0');
INSERT INTO functions (functionid, itemid, triggerid, name, parameter) VALUES (100041, 99087, 100041, 'last', '0');
INSERT INTO functions (functionid, itemid, triggerid, name, parameter) VALUES (100042, 99088, 100042, 'last', '0');
INSERT INTO functions (functionid, itemid, triggerid, name, parameter) VALUES (100043, 99089, 100043, 'last', '0');
INSERT INTO functions (functionid, itemid, triggerid, name, parameter) VALUES (100044, 99088, 100044, 'last', '0');
INSERT INTO history_uint (itemid, clock, value, ns) VALUES (99086, 1533555726, 1, 726692808);
INSERT INTO history_uint (itemid, clock, value, ns) VALUES (99087, 1533555726, 2, 726692808);
...
INSERT INTO events (eventid, source, object, objectid, clock, ns, value, name, severity) VALUES (9000, 0, 0, 100030, 1533555726, 726692808, 1, '1_trigger_Not_classified', 0);
INSERT INTO events (eventid, source, object, objectid, clock, ns, value, name, severity) VALUES (9001, 0, 0, 100031, 1533555726, 726692808, 1, '1_trigger_Information', 1);
INSERT INTO events (eventid, source, object, objectid, clock, ns, value, name, severity) VALUES (9002, 0, 0, 100032, 1533555726, 726692808, 1, '1_trigger_Warning', 2);
INSERT INTO events (eventid, source, object, objectid, clock, ns, value, name, severity) VALUES (9003, 0, 0, 100033, 1533555726, 726692808, 1, '1_trigger_Average', 3);
INSERT INTO events (eventid, source, object, objectid, clock, ns, value, name, severity) VALUES (9004, 0, 0, 100034, 1533555726, 726692808, 1, '1_trigger_High', 4);
INSERT INTO events (eventid, source, object, objectid, clock, ns, value, name, severity) VALUES (9005, 0, 0, 100035, 1533555726, 726692808, 1, '1_trigger_Disaster', 5);
INSERT INTO events (eventid, source, object, objectid, clock, ns, value, name, severity) VALUES (9006, 0, 0, 100036, 1533555726, 726692808, 1, '2_trigger_Not_classified', 0);
INSERT INTO events (eventid, source, object, objectid, clock, ns, value, name, severity, acknowledged) VALUES (9007, 0, 0, 100037, 1533555726, 726692808, 1, '2_trigger_Information', 1, 1);
INSERT INTO events (eventid, source, object, objectid, clock, ns, value, name, severity) VALUES (9008, 0, 0, 100038, 1533555726, 726692808, 1, '2_trigger_Warning', 2);
INSERT INTO events (eventid, source, object, objectid, clock, ns, value, name, severity) VALUES (9009, 0, 0, 100039, 1533555726, 726692808, 1, '2_trigger_Average', 3);
INSERT INTO events (eventid, source, object, objectid, clock, ns, value, name, severity) VALUES (9010, 0, 0, 100040, 1533555726, 726692808, 1, '2_trigger_High', 4);
INSERT INTO events (eventid, source, object, objectid, clock, ns, value, name, severity) VALUES (9011, 0, 0, 100041, 1533555726, 726692808, 1, '2_trigger_Disaster', 5);
INSERT INTO events (eventid, source, object, objectid, clock, ns, value, name, severity, acknowledged) VALUES (9012, 0, 0, 100042, 1533555726, 726692808, 1, '3_trigger_Average', 3, 1);
INSERT INTO events (eventid, source, object, objectid, clock, ns, value, name, severity) VALUES (9013, 0, 0, 100043, 1533555726, 726692808, 1, '4_trigger_Average', 3);
INSERT INTO problem (eventid, source, object, objectid, clock, ns, name, severity) VALUES ( 9000, 0, 0, 100030, 1533555726, 726692808, '1_trigger_Not_classified', 0);
INSERT INTO problem (eventid, source, object, objectid, clock, ns, name, severity) VALUES ( 9001, 0, 0, 100031, 1533555726, 726692808, '1_trigger_Information', 1);
INSERT INTO problem (eventid, source, object, objectid, clock, ns, name, severity) VALUES ( 9002, 0, 0, 100032, 1533555726, 726692808, '1_trigger_Warning', 2);
INSERT INTO problem (eventid, source, object, objectid, clock, ns, name, severity) VALUES ( 9003, 0, 0, 100033, 1533555726, 726692808, '1_trigger_Average', 3);
INSERT INTO problem (eventid, source, object, objectid, clock, ns, name, severity) VALUES ( 9004, 0, 0, 100034, 1533555726, 726692808, '1_trigger_High', 4);
INSERT INTO problem (eventid, source, object, objectid, clock, ns, name, severity) VALUES ( 9005, 0, 0, 100035, 1533555726, 726692808, '1_trigger_Disaster', 5);
INSERT INTO problem (eventid, source, object, objectid, clock, ns, name, severity) VALUES ( 9006, 0, 0, 100036, 1533555726, 726692808, '2_trigger_Not_classified', 0);
INSERT INTO problem (eventid, source, object, objectid, clock, ns, name, severity, acknowledged) VALUES ( 9007, 0, 0, 100037, 1533555726, 726692808, '2_trigger_Information', 1, 1);
INSERT INTO problem (eventid, source, object, objectid, clock, ns, name, severity) VALUES ( 9008, 0, 0, 100038, 1533555726, 726692808, '2_trigger_Warning', 2);
INSERT INTO problem (eventid, source, object, objectid, clock, ns, name, severity) VALUES ( 9009, 0, 0, 100039, 1533555726, 726692808, '2_trigger_Average', 3);
INSERT INTO problem (eventid, source, object, objectid, clock, ns, name, severity) VALUES ( 9010, 0, 0, 100040, 1533555726, 726692808, '2_trigger_High', 4);
INSERT INTO problem (eventid, source, object, objectid, clock, ns, name, severity) VALUES ( 9011, 0, 0, 100041, 1533555726, 726692808, '2_trigger_Disaster', 5);
INSERT INTO problem (eventid, source, object, objectid, clock, ns, name, severity, acknowledged) VALUES ( 9012, 0, 0, 100042, 1533555726, 726692808, '3_trigger_Average', 3, 1);
INSERT INTO problem (eventid, source, object, objectid, clock, ns, name, severity, acknowledged) VALUES ( 9013, 0, 0, 100043, 1533555726, 726692808, '4_trigger_Average', 3, 1);
INSERT INTO acknowledges (acknowledgeid, userid, eventid, clock, message, action, old_severity, new_severity) VALUES (1, 1, 9008, 1533629135, '1 acknowledged', 2, 0, 0);
INSERT INTO acknowledges (acknowledgeid, userid, eventid, clock, message, action, old_severity, new_severity) VALUES (2, 1, 9012, 1533629135, '2 acknowledged', 2, 0, 0);

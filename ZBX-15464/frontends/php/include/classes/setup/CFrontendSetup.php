...
class CFrontendSetup {
	...
	const MIN_PHP_MEMORY_LIMIT = 134217728; // 128*ZBX_KIBIBYTE*ZBX_KIBIBYTE
	const MIN_PHP_POST_MAX_SIZE = 16777216; // 16*ZBX_KIBIBYTE*ZBX_KIBIBYTE
	const MIN_PHP_UPLOAD_MAX_FILESIZE = 2097152; // 2*ZBX_KIBIBYTE*ZBX_KIBIBYTE

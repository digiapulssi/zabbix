...
class CActionButtonList extends CObject {
	...
	/**
	 * Prefix for session storage used for remembering which checkboxes have been checked when navigating between pages.
	 *
	 * @var string|null
	 */
	protected $sessionStoragePrefix = null;
	 ...
	 * @param string|null	$sessionStoragePrefix	Prefix for session storage used for storing currently selected checkboxes.
	 */
	function __construct($actionName, $checkboxesName, array $buttonsData, $sessionStoragePrefix = null) {
	...
	public function toString($destroy = true) {
		...
		zbx_add_post_js($this->widget_class.'.prefix = '.CJs::encodeJson($this->sessionStoragePrefix).';');

...
/* ATTENTION: For debugging only! */	zabbix_log(LOG_LEVEL_CRIT, "about to proces history data from %s", proxy.addr);
/* ATTENTION: For debugging only! */	DCremember_proxy_answer(proxy.hostid, answer);

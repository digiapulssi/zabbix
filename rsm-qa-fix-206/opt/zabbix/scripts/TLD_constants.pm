...
use constant HOSTGROUPS_TLD_PROBE_RESULTS =>
{
	TLD_TYPE_G() => TLD_TYPE_G() . ' Probe results',
	TLD_TYPE_CC() => TLD_TYPE_CC() . ' Probe results',
	TLD_TYPE_OTHER() => TLD_TYPE_OTHER() . ' Probe results',
	TLD_TYPE_TEST() => TLD_TYPE_TEST() . ' Probe results',
	'TLD' => 'TLD Probe results'
};

our @EXPORT_OK = qw(true false LINUX_TEMPLATEID APP_ZABBIX_PROXY_TEMPLATEID TEMPLATES_TLD_GROUPID PROBES_GROUPID PROBES_MON_GROUPID TLDS_GROUPID TLD_TYPE_GROUPIDS VALUE_TYPE_AVAIL VALUE_TYPE_PERC VALUE_TYPE_NUM
		    ...
		    rsm_host rsm_group rsm_value_mappings cfg_probe_status_delay
		    ...
		    APP_SLV_MONTHLY APP_SLV_ROLLWEEK APP_SLV_PARTTEST APP_SLV_CURMON TLD_TYPE_G TLD_TYPE_CC TLD_TYPE_OTHER TLD_TYPE_TEST HOSTGROUPS_TLD_PROBE_RESULTS);

our %EXPORT_TAGS = ( general => [ qw(true false) ],
		     templates => [ qw(LINUX_TEMPLATEID APP_ZABBIX_PROXY_TEMPLATEID) ],
		     groups => [ qw(TEMPLATES_TLD_GROUPID PROBES_GROUPID PROBES_MON_GROUPID TLDS_GROUPID TLD_TYPE_GROUPIDS) ],
		    ...
		    config => [ qw(cfg_probe_status_delay cfg_default_rdds_ns_string rsm_value_mappings rsm_trigger_rollweek_thresholds
				    cfg_global_macros TLD_TYPE_G TLD_TYPE_CC TLD_TYPE_OTHER TLD_TYPE_TEST HOSTGROUPS_TLD_PROBE_RESULTS) ],

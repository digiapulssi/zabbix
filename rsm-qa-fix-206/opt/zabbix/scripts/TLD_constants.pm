...
our @EXPORT_OK = qw(true false LINUX_TEMPLATEID APP_ZABBIX_PROXY_TEMPLATEID TEMPLATES_TLD_GROUPID PROBES_GROUPID PROBES_MON_GROUPID VALUE_TYPE_AVAIL VALUE_TYPE_PERC VALUE_TYPE_NUM
...
our %EXPORT_TAGS = ( general => [ qw(true false) ],
		     ...
		     groups => [ qw(TEMPLATES_TLD_GROUPID PROBES_GROUPID PROBES_MON_GROUPID) ],
